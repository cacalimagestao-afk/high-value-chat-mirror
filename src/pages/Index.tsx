...
const cotas = [
  ...
  },
  {
    ...
    items: [
      "Tema desenvolvido exclusivamente",
      "Roteiro co-criado com sua equipe",
      "Edição premium com trilha dedicada",
      "Liderança de mentalidade no mercado",
      "Conteúdo evergreen para uso contínuo",
  ...
  },
  {
    ...
    items: [
      ...
      "Seu representante como convidado principal",
      "Storytelling personalizado e humanizado",
      "Distribuição: TV + redes sociais + YouTube",
      "Versão estendida para redes sociais",
      "Crédito oficial destacado no encerramento",
    ],
    ideal: "Marcas que desejam o máximo de exposição com narrativa profunda e formato imersivo.",
  },
];
...
const cotasComplementares = [
  {
    ...
    items: [
      ...
      "Exposição em redes sociais da apresentadora",
      "Associação direta à imagem da apresentadora",
      "Valorização do lifestyle da marca",
      "Opção: peças cedidas ou doadas",
    ],
  ...
  },
  {
    ...
    items: [
      ...
      "Menção natural por Cacá Lima",
      "Associação sutil com o programa",
      "Reforço estético e emocional de marca",
      "Presença 100% orgânica e integrada",
    ],
        ...
        <div className="container mx-auto relative z-10 pt-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-display text-5xl md:text-7xl lg:text-8xl leading-[1.05] mb-8">
              Profundidade, propósito e{" "}
              <span className="text-gradient-gold italic">narrativa humana</span>.
            </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 max-w-5xl mx-auto">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-[calc(50%-0.5rem)] sm:w-[calc(33.333%-1rem)] md:w-[calc(20%-1.2rem)] rounded-xl border border-border/60 bg-card/40 hover:border-gold/60 hover:bg-card/80 transition-smooth flex items-center justify-center p-4 sm:p-5 h-28 sm:h-32"
                title={p.title}
              >
                <img src={p.logo} alt={`Logo ${p.name} — parceiro do Conversas de Alto Valor`} className="max-h-16 sm:max-h-20 max-w-full object-contain opacity-80 group-hover:opacity-100 transition-smooth" />
              </a>
            ))}
          </div>
